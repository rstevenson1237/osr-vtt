...
- **DEC-086** — On what terms does the Worldographer terrain pack replace the current one? → `docs/decisions/DEC-086.md`
- **DEC-087** — Where does a terrain overlay's ink colour come from? → `docs/decisions/DEC-087.md`
