...
| ---------- | ---------------------------------------------------------------------------------------------------------------------------- | -------------- | ------ | ------------- | -------- | ------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **WI-052** | Path ⇄ Corridor: the snap indicator shows the band actually being carved                                                     | SPEC-028 §6    | IN-028 | `claude-code` | `sonnet` | medium | Four-section gate. **IN PROGRESS — implementation landed, running `pnpm test:all:emulators` for verification (step 4 of 5: unit tests green, e2e running).** `targetedBandFor`/`targetedBandRect` added, `cursorBand` wired into the engine and `VectorMapView`, `snap-band-readout` mirror added. |
