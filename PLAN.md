...
| ---------- | ---------------------------------------------------------------------------------------------------------------------------- | -------------- | ------ | ------------- | -------- | ------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **WI-052** | Path ⇄ Corridor: the snap indicator shows the band actually being carved                                                     | SPEC-028 §6    | IN-028 | `claude-code` | `sonnet` | medium | Four-section gate. **IN PROGRESS — implementation committed and pushed (ed8003e). Unit/rules/store tests green. First `pnpm test:all:emulators` e2e run failed on an environment crash (vite dev server died mid-run, unrelated ERR_CONNECTION_REFUSED across unrelated specs after test 5) — re-running now for a clean verification.** |
