...
| ---------- | ---------------------------------------------------------------------------------------------------------------------------- | -------------- | ------ | ------------- | -------- | ------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **WI-052** | Path ⇄ Corridor: the snap indicator shows the band actually being carved                                                     | SPEC-028 §6    | IN-028 | `claude-code` | `sonnet` | medium | Four-section gate. **IN PROGRESS — second full-suite run was 71/72 e2e green; the one failure was a bug in the new WI-052 e2e test itself (didn't account for DEC-028's unconditional width reset on snap-mode change), not the product. Test fixed, re-verifying that one spec now before a final full re-run.** |
