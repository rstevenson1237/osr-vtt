...
**Provenance is a gate on this section, not a footnote.** The pack carries no licence or
authorship metadata. SPEC-003 §5's licence discipline is a permanent standing constraint and
cites an `ATTRIBUTION.md` that does not exist (IN-078). **These files do not land in
`apps/web/public/` until their origin is recorded there.** If they were authored for this
project, saying so in `ATTRIBUTION.md` is sufficient and closes IN-078's first entry in the same
change.
...
> **Blocked on the provenance question above being answered.**
