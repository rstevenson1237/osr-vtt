...
> **Reopened by DEC-102** (open, 2026-09-18): IN-145 asks whether the hook's durable state
> should move off a tracked file, or whether the guard is still needed at all. This entry is
> named and reconsidered there, not overwritten here (RULE-019).
