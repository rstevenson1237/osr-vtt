...
| IN-114 | Obsolete WI-101's hex terrain art in favour of the public-domain Worldographer/Inkwell Ideas icon sets                                              | **Deceptive**                    | **Scheduled**   | DEC-088/DEC-089 answered. **WI-119 (reference sheet) has run and closed 2026-09-09** — `docs/completed/WI-119.md`. WI-120 next, taking its proposal as input.                                                              |
