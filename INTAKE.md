...
| IN-109 | Retire the `gen:disc:` letter mechanic: the letter becomes stored data drawn over any art, and everything that reads a letter out of a ref migrates | **Complex (Shape A — reversal)** | **Scheduled**   | WI-113 (**closed 2026-09-09** — schema v30, the fields and the backfill), WI-114 (**closed 2026-09-09** — assignment reads the field), WI-116 / DEC-087 (a) / SPEC-048 §§1–3, §5 — supersedes SPEC-040 §4 in place; DEC-072 not reopened                                         |
