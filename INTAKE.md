...
| ------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| IN-119 | An `.svg` token renders as a black square on the map | **Simple** | **Closed** — WI-125 (2026-09-13), SPEC-007: `loadTokenTexture` now rejects a zero-`naturalWidth`/`naturalHeight` `HTMLImageElement` into the existing broken-image path instead of uploading it to WebGL as an untextured (black) quad. See `docs/completed/WI-125.md`. |
